...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text4: darkMode ? '#FFFFFF' : '#000000',
    text5: darkMode ? '#FFFFFF' : '#000000',

    // backgrounds / greys
    bg1: darkMode ? '#141414' : '#FFFFFF',
    bg1And2: darkMode ? '#141414' : '#FFFFFF',
    bg2: darkMode ? '#262626' : '#141414',
    bg3: darkMode ? '#141414' : '#262626',
    bg4: darkMode ? '#262626' : '#141414',
    bg5: darkMode ? '#262626' : '#141414',
    bg6: darkMode ? '#141414' : '#262626',
    ...
    //primary colors
    primary1: darkMode ? '#0E0E0E' : '#262626',
    primary2: darkMode ? '#0E0E0E' : '#262626',
    primary3: darkMode ? '#0E0E0E' : '#262626',
    primary4: darkMode ? '#0E0E0E' : '#262626',
    primary5: darkMode ? '#0E0E0E' : '#262626',

    // color text
    primaryText1: darkMode ? '#ffffff' : '#ffff',

    // secondary colors
    secondary1: darkMode ? '#0E0E0E' : '#262626',
    secondary2: darkMode ? '#0E0E0E' : '#262626',
    secondary3: darkMode ? '#0E0E0E' : '#262626',
